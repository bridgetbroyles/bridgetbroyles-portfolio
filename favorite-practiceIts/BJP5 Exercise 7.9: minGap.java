...
because that is the smallest gap in the array. Notice that the minimum gap could be a 
...
For example, if the minimum gap is greater than or equal to 0, then you know the array
is in sorted (nondecreasing) order. If the gap is greater than 0, then you know the array
is both sorted and unique (strictly increasing).
